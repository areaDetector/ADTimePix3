...
* **Medipix3 (development on `medipix3-integration`)**: unified driver with runtime `DetectorFamily` detection, capability PVs, and IOC profile `st_mpx3.cmd` — validated on emulator; hardware checkout pending — [documentation/medipix3/integration.md](documentation/medipix3/integration.md) ([index](documentation/medipix3/README.md)).
