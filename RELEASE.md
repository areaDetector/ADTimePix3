...
* **MPX3 packed PixelConfig layout**:
  ...
  * Place MPX3 diff pixels using Serval's per-chip rotated layout instead of the TPX3 quad map. The validated `UP` layout assigns chips 1/0 to the top row and 2/3 to the bottom row, with the bottom chips rotated 180 degrees.
  ...
  * MPX3 operator mask read/write/export remains unavailable pending final vendor confirmation of set/clear and reserved-bit rules.
