...
# Prefer driver NDArray addr 9/12 (wired in profiles/mpx3/plugins_mpx3.cmd); use this only with the
# commented plugin block in plugins_mpx3.cmd (not together with driver Pva5/Pva6).
